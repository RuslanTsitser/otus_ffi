...
class FfiLibBindings {
  ...
  ffi.Pointer<ffi.Char> execute_python_code_with_output(
    ffi.Pointer<ffi.Char> python_code,
  ) {
    return _execute_python_code_with_output(python_code);
  }

  late final _execute_python_code_with_outputPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
        >
      >('execute_python_code_with_output');
  late final _execute_python_code_with_output =
      _execute_python_code_with_outputPtr
          .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
  ...
  void free_python_result(ffi.Pointer<ffi.Char> ptr) {
    return _free_python_result(ptr);
  }

  late final _free_python_resultPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>(
        'free_python_result',
      );
  late final _free_python_result = _free_python_resultPtr
      .asFunction<void Function(ffi.Pointer<ffi.Char>)>();
  ...
  /// * `-1` - ошибка выполнения
  int execute_python_code(ffi.Pointer<ffi.Char> python_code) {
    return _execute_python_code(python_code);
  }

  late final _execute_python_codePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char>)>>(
        'execute_python_code',
      );
  late final _execute_python_code = _execute_python_codePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>)>();
}
