...
class FfiLibBindings {
  ...
  int resize_image_file(
    ffi.Pointer<ffi.Char> input_path,
    ffi.Pointer<ffi.Char> output_path,
  ) {
    return _resize_image_file(input_path, output_path);
  }

  late final _resize_image_filePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)
        >
      >('resize_image_file');
  late final _resize_image_file = _resize_image_filePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();
  ...
  /// Функция небезопасна, так как работает с C строками.
  /// Вызывающий код должен обеспечить корректность путей.
  int rotate_image_90_file(
    ffi.Pointer<ffi.Char> input_path,
    ffi.Pointer<ffi.Char> output_path,
  ) {
    return _rotate_image_90_file(input_path, output_path);
  }

  late final _rotate_image_90_filePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)
        >
      >('rotate_image_90_file');
  late final _rotate_image_90_file = _rotate_image_90_filePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();
  ...
  ffi.Pointer<ffi.UnsignedChar> rgba_to_jpeg(
    ffi.Pointer<ffi.UnsignedChar> rgba_ptr,
    int width,
    int height,
    int quality,
    ffi.Pointer<ffi.UintPtr> output_len,
  ) {
    return _rgba_to_jpeg(rgba_ptr, width, height, quality, output_len);
  }

  late final _rgba_to_jpegPtr =
      _lookup<
        ffi.NativeFunction<
        ...
        >
      >('rgba_to_jpeg');
  late final _rgba_to_jpeg = _rgba_to_jpegPtr
      .asFunction<
        ffi.Pointer<ffi.UnsignedChar> Function(
          ffi.Pointer<ffi.UnsignedChar>,
          int,
  ...
  void free_image(ffi.Pointer<ffi.Void> ptr, int len) {
    return _free_image(ptr, len);
  }

  late final _free_imagePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.UintPtr)
        >
      >('free_image');
  late final _free_image = _free_imagePtr
      .asFunction<void Function(ffi.Pointer<ffi.Void>, int)>();
}
