...
class FfiLibBindings {
  ...
  int encode_base64_file(
    ffi.Pointer<ffi.Char> input_path,
    ffi.Pointer<ffi.Char> output_path,
  ) {
    return _encode_base64_file(input_path, output_path);
  }

  late final _encode_base64_filePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)
        >
      >('encode_base64_file');
  late final _encode_base64_file = _encode_base64_filePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();

  int decode_base64_file(
    ffi.Pointer<ffi.Char> input_path,
    ffi.Pointer<ffi.Char> output_path,
  ) {
    return _decode_base64_file(input_path, output_path);
  }

  late final _decode_base64_filePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)
        >
      >('decode_base64_file');
  late final _decode_base64_file = _decode_base64_filePtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();

  void free_buffer(ffi.Pointer<ffi.Uint8> ptr) {
    return _free_buffer(ptr);
  }
