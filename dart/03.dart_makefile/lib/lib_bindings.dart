...
class LibBindings {
  ...
  LibBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LibBindings.fromLookup(
  ...
  ffi.Pointer<ffi.Char> get_string_length_with_static(
    ffi.Pointer<ffi.Char> str,
  ) {
    return _get_string_length_with_static(str);
  }

  late final _get_string_length_with_staticPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
        >
      >('get_string_length_with_static');
  late final _get_string_length_with_static = _get_string_length_with_staticPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> get_string_length_with_malloc(
    ffi.Pointer<ffi.Char> str,
  ) {
    return _get_string_length_with_malloc(str);
  }

  late final _get_string_length_with_mallocPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
        >
      >('get_string_length_with_malloc');
  late final _get_string_length_with_malloc = _get_string_length_with_mallocPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  void lib_free(ffi.Pointer<ffi.Char> ptr) {
    return _lib_free(ptr);
  }
